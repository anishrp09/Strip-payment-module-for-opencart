...
class ControllerExtensionPaymentStripePayments extends Controller {
	public function index() {
		...
		//}	
                return $this->load->view('extension/payment/stripe_payments', $data);
	...
	public function confirm() {
        ...
        require_once('./vendor/stripe/stripe-php/lib/Stripe/Customer.php');
        require_once('./vendor/stripe/stripe-php/lib/Stripe/Charge.php');

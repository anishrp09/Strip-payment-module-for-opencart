...
class  ControllerExtensionPaymentStripePayments extends Controller {
	...
	public function index() {
		$this->load->language('extension/payment/stripe_payments');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/stripe_payments', 'token=' . $this->session->data['token'], true)
		);

		//$data['action'] = HTTPS_SERVER . 'index.php?route=xtension/payment/stripe_payments&token=' . $this->session->data['token'];

		//$data['cancel'] = HTTPS_SERVER . 'index.php?route=extension/extension&token=' . $this->session->data['token'];
                $data['action'] = $this->url->link('extension/payment/stripe_payments', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('extension/payment/stripe_payments', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/payment/stripe_payments')) {
